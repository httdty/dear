...
def model_process(data_group):
 ...
 #   output_1 = output_1[shuffler]
   ...
   # output_2 = output_2[shuffler]
    ...
    np.save("data_1.npy", input_1)
    np.save("data_2.npy", output_1)
    training_input_1 = input_1[:int(data_1 * 8 / 10)]
    training_output_1 = output_1[:int(data_1 * 8 / 10)]
    testing_input_1 = input_1[int(data_1 * 8 / 10):]
    testing_output_1 = output_1[int(data_1 * 8 / 10):]
    training_input_2 = input_2[:int(data_2 * 8 / 10)]
    training_output_2 = output_2[:int(data_2 * 8 / 10)]
    testing_input_2 = input_2[int(data_2 * 8 / 10):]
    testing_output_2 = output_2[int(data_2 * 8 / 10):]
    learning_model = qu_model(len(training_input_1[0]), len(training_output_1[0]), 128, 128, 128, 0.5)
    learning_model.fit(training_input_1, training_output_1, batch_size=128, epochs=1)
    ...
    learning_model_2.fit(training_input_2, training_output_2, batch_size=128, epochs=1)
...
def model_process_2(data_group):
    input_1 = data_group[0]
    output_1 = data_group[1]
 #   shuffler = np.random.permutation(len(input_1))
  #  input_1 = input_1[shuffler]
